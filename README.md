...
<head>
    ...
    <title>My Financial Tools</title>
    <style>
...
<body>
    <div class="container">
        <h1>Welcome to My Financial Tools 🧰</h1>
        <p>This is a central hub for all my custom-built financial web applications and tools. Please select a tool from the list below to get started.</p>
